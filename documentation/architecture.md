...
## Overview
The system architecture consists of three learning paradigms evaluated progressively

1. Centralized Learning with Federated Learning (FL)
2. LiteChain-based BCFL
3. Proposed LiteChain-CLO Framework
